...
| ------- | ---------- | --------------------------------------------------------------------------------------------------- | --------------------------- |
| 0.2.6.1 | 2026-09-03 | **Cities:** Part of _Western Siberia_. Now using the help of the "Dynamic Province Names" mod to get different city names when the original isn't available.<br>Converted `provinces.xlsx` to `provinces.ods` for usage of LibreOffice.| 774/3359 
